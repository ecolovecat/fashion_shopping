...
$id = $size = $thumbnail = $pname = $price = $discount = $category_id = $description = $min_age = '';
                        ...
                        <div class="row">
                            <div class="col-md-9 col-12">
                                <div class="form-group">
                                    ...
                                    <input required="true" type="text" class="form-control" id="usr" name="pname" value="<?=$pname?>">
